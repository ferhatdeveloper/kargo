...
Bu belge, Stocado müşteri panelindeki **her menü sayfasının** tasarım yapısını, form alanlarını, tabloları, filtreleri ve API ipuçlarını kaydeder. Navlun (`portal/`) ile karşılaştırma sütunu her sayfada verilir.
...
20. [Navlun parite matrisi](#20-navlun-parite-matrisi)
...
**Navlun:** Split-layout korunuyor (ürün kararı); Stocado ile bire bir değil.
...
**Navlun:** Kartlar ve grafikler var; harita ve KÖ/Finans sekmeleri içeriği zayıf.
...
**Navlun:** Stepper + panel var; adres/ürün modalları ve canlı teklif API tam değil.
...
**Navlun:** Tablo ve filtre iskeleti var; kolon menüleri, logo, toplu işlem, export gerçek değil.
...
**Navlun:** `PlaceholderPage` — **tam eksik**.
...
**Navlun:** Liste var; oluştur/düzenle modal ve API CRUD eksik.
...
**Navlun:** Sekmeler + örnek tablo; gerçek plan API’si yok.
...
**Navlun:** Pazaryeri grid var; bağlan akışı ve diğer sekmeler iskelet.
...
**Navlun:** Genel bakış kısmen; diğer sekmeler boş metin.
...
**Navlun:** Sekme isimleri var; çoğu panel “yakında” metni.
...
Navlun PostgREST hedefi: `db/migrations/*`, RPC’ler (`account_cargos_query`, vb.).

---

## 20. Navlun parite matrisi

| Sayfa | Stocado derinliği | Navlun durumu | Boş/iskelet hissi |
|-------|-------------------|---------------|-------------------|
...
**Sonuç:** Navlun’da ~**9/18** ana iş sayfası hâlâ placeholder veya yalnızca statik iskelet; bu yüzden “boş taslak” algısı doğru.
